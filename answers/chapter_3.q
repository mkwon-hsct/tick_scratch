/
* @file chapter_3.q
* @overview Anser keys for the exercises of the chapter 3.
\

// Expand the width of console
\c 25 200
...
exercise_4:{[num]
  ...
  // Iterate until the last element becomes 1 or the length of the sequence becomes larger than 20
...
exercise_5:{[truefalse; true_seq; false_seq]
  inner:{[seq; true_val; false_val]
    // Replace the first non-boolean value.
